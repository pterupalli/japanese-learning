...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Initial beginner videos loaded');
});
...
function setupTrackButtons() {
    ...
    // Map of track titles to lesson pages
    const lessonMap = {
    ...
    trackButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            if (lessonPage === 'lesson-hiragana.html') {
                // Hiragana lesson is ready
                window.location.href = lessonPage;
            } else {
                // Other lessons coming soon
                alert(`${trackTitle}\n\nLesson content coming soon! 📚\n\nFor now, try the Hiragana Basics lesson.`);
            }
